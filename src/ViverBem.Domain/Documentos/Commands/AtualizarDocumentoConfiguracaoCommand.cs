...
{
    public class AtualizarDocumentoConfiguracaoCommand : BaseDocumentoConfiguracaoCommand
    {
        public AtualizarDocumentoConfiguracaoCommand(Guid nrseqdocumentoconfiguracao, string cddocumentoconfiguracao, Int32 nrordem, Int32 nrcoluna, string nobackgroundcolor, string nohorizontalaligment
