...
{
    public class RegistrarDocumentoConfiguracaoCommand : Command
    {
        ...
        public RegistrarDocumentoConfiguracaoCommand(Guid nrseqdocumentoconfiguracao,string cddocumentoconfiguracao,Int32 nrordem,Int32 nrcoluna, string nobackgroundcolor,string nohorizontalaligment
