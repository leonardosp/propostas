...
{
    public class DocumentoConfiguracaoItemAtualizadoEvent : Event
    {
        ...
        public DocumentoConfiguracaoItemAtualizadoEvent(string nofonte, string nofontecolor, string nofrase, bool flgpropriedade, Int32 nrcoluna, Guid nrseqdocumentoconfiguracaoitem, Int32 nrfontetamanho,
