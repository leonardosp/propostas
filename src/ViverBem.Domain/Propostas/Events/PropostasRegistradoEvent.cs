...
{
    public class PropostasRegistradoEvent : BasePropostasEvent
    {
        public PropostasRegistradoEvent(DateTime dataVenda, string id_ext_props, string tp_pgto, string cpf, string nome,
 DateTime dt_nasc, string sexo, string est_civil, string ender, string endnum, string endcomplemento, string bairro, string cidade, string uf, string cep, string dddtel, string tel, string dddcel, string cel,
          ...
          string cc_dv, string diadebito, string tipoenvio, string endercobr, string endnumcobr, string endcomplcobr, string ppe,string bairrocobr, string cidadecobr, string ufcobr, string cepcobr, Guid iddoclientex)
        {
            DataVenda = dataVenda;
            PPE = ppe;
