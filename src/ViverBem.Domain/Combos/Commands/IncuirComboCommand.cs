...
{
    public class IncuirComboCommand : Command
    {
        ...
        public IncuirComboCommand(string codcombo, string planosrv, Guid comboId, Guid? comoboPrincipalId, string plaprinserv, string vlrpremio, string vlrcapital, string codcomissusr)
        {
            AggregateId = comboId;
            ComboId = comboId;
