...
{
    public class ComboAdicionadoEvent : Event
    {
        ...
        public ComboAdicionadoEvent(string codcombo,string planosrv, string plaprinserv,string vlrpremio,string vlrcapital,Guid? comboprincid,string codcomissuusr,Guid comboid)
        {
            CodCombo = codcombo;
            PlanoSrv = planosrv;
