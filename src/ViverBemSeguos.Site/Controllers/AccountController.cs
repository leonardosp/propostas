...
using ViverBem.Infra.CrossCutting.Identity.Models.AccountViewModels;
...
namespace ViverBemSeguos.Site.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public AccountController(
            ...
            IDomainNotificationHandler<DomainNotification> notifications, IFuncionarioAppService funcionarioAppService, IUser user) : base(notifications, user)
        {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = Convert.ToString(model.CPF), Email = Convert.ToString(model.CPF) };
                ...
                if (result.Succeeded)
                {
                    ...
                    _funcionarioAppService.Registrar(funcionario);
                    ...
                    await _userManager.AddClaimAsync(user, new Claim(model.Hierarquia, model.Hierarquia));
        ...
        public async Task<IActionResult> Logout()
        {
            ...
            return RedirectToAction(nameof(PropostasController.Index), "Home");
        }
